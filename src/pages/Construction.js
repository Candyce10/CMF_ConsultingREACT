        ...
        <div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
                <div class="container">
                    ...
                    <div class="">
                        <a href="#contact" class="btn btn-brand ms-lg-3">{t('trans.contact')}</a>
                    </div>
                </div>
            </nav>
            ...
            <div class="const-image" style={{"background-color": "#03213c"}}>
                <div class="container">
                    <div class="px-4 py-5 text-center justify-content-center">
                        ...
                        <p class="lead" style={{"color":"rgb(241, 241, 241)"}}>{t('trans.headqt')}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row text-center justify-content-center ">
            <div class="col-lg-10 col-sm-6">
                <h1 class="display-6 ">{t('trans.greenct')}</h1>
                <p class="mb-0 " style={{"font-size": "20px"}}>{t('trans.greenct2')}</p>
            </div>
        </div>
    </div>
</section>
